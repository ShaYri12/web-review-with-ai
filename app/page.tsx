...
export default function Home() {
  ...
  return (
    <div className="h-screen flex flex-col justify-between min-h-full items-center bg-[#252A2E] text-white">
      ...
      <main className="px-4 lg:px-[24px] 3xl:py-[47px] py-[23px] my-auto">
        <div className="3xl:max-w-[1600px] 2xl:max-w-[1280px] max-w-[1280px] mx-auto">
          <div className="">
            <div className="flex items-center space-x-4">
              <h1 className="xl:font-[800] font-[700] text-[37px] sm:text-[40px] md:text-[48px] lg:text-[60px] xl:text-[70px] 3xl:text-[90px] 2xl:leading-[100.18px] lg:leading-[110px] md:leading-[90px] sm:leading-[80px] leading-[50px]">
            ...
            <div className="3xl:mt-[70px] lg:mt-[50px] md:mt-[60px] mt-[50px] flex lg:flex-row flex-col justify-between gap-8 xl:gap-[100px]">
                ...
                <div className="flex items-center space-x-2 md:space-x-4 lg:space-x-[20px] 3xl:space-x-[26px] 3xl:mb-[100px] lg:mb-[70px] sm:mb-[65px] mb-[40px]">
                  ...
                  <span className="relative text-[18px] lg:text-[20px] 3xl:text-[25px]">
                    ...
                    <Image
                      ...
                      width={150.91}
                      height={117.5}
                      className="sm:block hidden 3xl:w-[144px] xl:w-[105px] w-[89px] 3xl:h-[117.5px] absolute 3xl:right-[-170px] xl:right-[-120px] right-[-100px] top-[15px]"
                    />
                  </span>
                </div>
              ...
              <div className="relative flex lg:flex-nowrap flex-wrap lg:items-start justify-between gap-[18px]">
                ...
                <Image
                  ...
                  width={414.5}
                  height={131.28}
                  className="lg:block hidden 3xl:w-[414.5px] xl:w-[300px] w-[240px] 3xl:h-[131.28px] absolute 3xl:left-[-260px] xl:left-[-190px] left-[-120px] 3xl:top-[82%] xl:top-[73%] top-[60%] -translate-y-1/2"
                />
              </div>
            </div>
          </div>
